  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="max-w-4xl mx-auto py-6">
        <h2 className="text-3xl font-semibold mb-6 text-center">Riwayat Pesanan</h2>
        <div className="space-y-6">
          {Object.keys(riwayat).length === 0 ? (
            <div className="text-center">Tidak ada riwayat pesanan.</div>
          ) : (
            Object.keys(riwayat)
              .reverse()
              .map((orderId) => {
                ...
                return (
                  <div key={orderId} className="p-6 border border-purple-200 bg-white rounded-lg shadow-lg">
                    <h3 className="font-semibold mb-4">Pesanan ID: {orderId}</h3>
                      ...
                      return (
                        <div key={itemId} className="flex items-center space-x-4 mb-4 last:mb-0">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-sm ">Total: {(item.product.harga * item.jumlah).toLocaleString()} IDR</div>
                          </div>
                        </div>
                      );
                    })}
